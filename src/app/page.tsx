...
import Header from '@/components/Header'; // Although layout handles header/footer, Home component imports them too in original.
// But in Next.js App Router, Header/Footer are usually in layout.
// I should remove them from Home component if they are in layout.
// I see Home.tsx was using them.
// I will rewrite Home component to NOT include Header and Footer.
    ...
    <>
      ...
      <section id="zielgruppen" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Persona 1 */}
              <Link href="/fuer-neulinge" className="text-center p-6 rounded-2xl hover:bg-gray-90 transition-colors group">
              ...
              {/* Persona 2 */}
              <Link href="/fuer-berufstaetige" className="text-center p-6 rounded-2xl hover:bg-gray-90 transition-colors group">
                <div className="w-16 h-16 mx-auto bg-gray-80 rounded-full flex items-center justify-center mb-6 text-white group-hover:scale-110 transition-transform">
                    <RocketIcon />
                </div>
              ...
              {/* Persona 3 */}
              <Link href="/fuer-manager-strategen" className="text-center p-6 rounded-2xl hover:bg-gray-90 transition-colors group">
                <div className="w-16 h-16 mx-auto bg-gray-80 rounded-full flex items-center justify-center mb-6 text-white group-hover:scale-110 transition-transform">
                    <GearsIcon />
                </div>
